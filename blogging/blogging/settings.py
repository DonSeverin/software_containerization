...
TEMPLATE_DIR_BLOGGER_APP = BASE_DIR / ''
TEMPLATE_DIR_BLOGGER_API = BASE_DIR / ''
...
SECRET_KEY = 'django-insecure-xw@*onqsg7n7o5t2$dwbc62m2@&8o@6gxy*wzbop+yib)_n5vi'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATE_DIR_BLOGGER_APP, TEMPLATE_DIR_BLOGGER_API],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
